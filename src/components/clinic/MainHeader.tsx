...
import { Clock, Phone, Copy, X } from "lucide-react";
...
const MainHeader: React.FC = () => {
  ...
  const googleReviewLink =
    "https://www.google.com/search?sca_esv=df25ec6ca4037ad0&sxsrf=ANbL-n55CKKZgPxnw-BVl9TiiyveL4zfCQ:1775033933579&si=AL3DRZEsmMGCryMMFSHJ3StBhOdZ2-6yYkXd_doETEE1OR-qORE9vJlCHojPZZozkvgwp1qL6c4fdhtrp9cxitJJ_fzPAizSyXtdve8Oz9RX6jfUyYCRF7z9lkHS5AGibmQFE5aLN6fcsWMJ_TszY6d-GoQLOR_vEg6pqgTT9wHWaJU6QQbvzi4%3D&q=Dr+Shewale%5C%27s+Sai+Heart+%26+Maternity+Care+Reviews&sa=X&ved=2ahUKEwjo4MzYpMyTAxVsUGwGHT5EBBcQ0bkNegQILhAF&biw=1440&bih=778&dpr=2#lrd=0x3bc5da77cd8ed7d3:0xf42da816260d47f4,3,,,,";
  return (
    <>
      <style>
        {`
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="grid grid-cols-2 lg:flex items-center gap-2 sm:gap-4 lg:gap-8">
              ...
              <div className="flex items-center gap-2 p-2 bg-white/60 rounded-lg border border-blue-100 lg:bg-transparent lg:border-none overflow-hidden">
                ...
                <div className="min-w-0">
                  <p className="text-[9px] uppercase font-bold text-slate-500 truncate">
                    {t("header.visiting_hours")}
                  </p>

                  <p className="text-[10px] sm:text-sm font-bold text-slate-700 truncate">
                    {t("header.hours_value")}
                  </p>
                </div>
              </div>
              ...
              <button
                ...
                className="emergency-badge flex items-center gap-2 bg-white border border-red-200 rounded-lg px-2 py-2 lg:bg-red-50 overflow-hidden transition-all hover:scale-105"
              >
                <span className="live-dot w-2 h-2 rounded-full bg-red-500 flex-shrink-0" />

                <div className="min-w-0 text-left">
                  <p className="text-[9px] font-bold text-red-500 uppercase tracking-tight truncate">
                    Emergency
                  </p>

                  <p className="text-[10px] sm:text-sm font-black text-red-600 truncate">
                    {phoneNumber}
                  </p>
                </div>
              </button>
            ...
            <div className="flex items-center justify-between lg:justify-end gap-2 pt-2 lg:pt-0 border-t border-blue-100 lg:border-none">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  <span className="text-[8px] font-bold text-blue-700 uppercase mt-1">
                    Find Us
                  </span>
                </a>
                ...
                >
                  ...
                  <span className="text-[8px] font-bold text-green-700 uppercase mt-1">
                    Rate Us
                  </span>
                </a>
              </div>
        ...
        >
          ...
          >
            ...
            <p className="text-center text-gray-500 text-sm mb-6">
              Call now or copy the number below
            </p>
